...
\cventry{
    ...
    {March. 2023 - Present}
    {
 	 ...
 	 \item {Developed and improved data pipelines for ingesting and enriching live field equipment data}
  	\item {Created  APIs for downstream teams to leverage functionalities and insights from the enriched data}
  	\item {Utilized Scala, Spark, Apache Flink, HBase, and Geomesa to build robust solutions for data processing}
